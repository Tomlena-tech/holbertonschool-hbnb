#!/usr/bin/python3
"""User model with property validation"""
...
class User(BaseModel):
    ...
    def add_place(self, place):
        ...
        Args:
            place (Place): A Place instance to associate with the user.
        """
    ...
    def add_review(self, review):
        ...
        Args:
            review (Review): A Review instance to associate with the user.
        """
    ...
    def delete_review(self, review):
        ...
        Args:
            review (Review): The Review instance to remove.
